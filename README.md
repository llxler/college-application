...
这是一个基于 `table.xlsx` 的本地 Streamlit 工具，用于按批次、科目、类别、省份、分数、位次、专业关键词、学校性质和备注条件筛选院校专业组，并按“冲 / 稳 / 保”生成推荐结果。
...
- 省份为“湖北”或“湖北省”的数据统一为“湖北省”，空值、其他值及没有省份列的数据归为“其他”。
- 艺术本科表尾部空列会被忽略。
